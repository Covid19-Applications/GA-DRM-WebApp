...
<br><br><br> 
<center>
<a href="https://karunadu.karnataka.gov.in/hfw/nhm/Documents/DCHs.pdf">
<button   id="mapsbtn" >List Of Dedicated Covid19 Hospitals</button></a></center><br><br>
  ...
  <div class="whole-wrap">
                        <div class="container box_1170">
                            ...
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25" style="text-align: center;">Hospitals In Goa</h2>
                                 <?php
                                  $query = "SELECT * FROM hosp_list WHERE state='goa'";
