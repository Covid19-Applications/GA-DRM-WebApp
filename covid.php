            ...
            <div class="major-caousel js-carousel-1 owl-carousel">
              ...
              <div>
                <div class="media d-block media-custom text-center"><br>
                  <a href="covid_ind/Tracker - Odisha/index.php"><img src="img/goa/map1.jpg" alt="Image Placeholder" class="img-fluid"></a>
                 
                  <div class="media-body" style="background-color: #121212">
                    <h3 class="mt-0 text-white">GOA</h3>
        ...
        <div class="row mb-5">
          <div class="col-md-4 mb-5">
            ...
            <ul class="list-unstyled footer-link d-flex footer-social">
              <li><a href="#" class="p-2" style="color: crimson"><span class="fa fa-twitter"></span></a></li>
              <li><a href="#" class="p-2"style="color: crimson"><span class="fa fa-facebook"></span></a></li>
              <li><a href="#" class="p-2"style="color: crimson"><span class="fa fa-linkedin"></span></a></li>
              <li><a href="#" class="p-2"style="color: crimson"><span class="fa fa-instagram"></span></a></li>
            </ul>
          ...
          <div class="col-md-5 mb-5">
            ...
            <div>
              ...
              <ul class="list-unstyled footer-link">
                <li class="d-block">
                  <span class="d-block text-grey"style="color: crimson">Address:</span>
                  <span style="color: crimson">34 Street Name, Goa, India</span></li>
                <li class="d-block" ><span class="d-block text-grey"style="color: crimson" >Phone:</span><span>+1 242 4942 290</span></li>
                <li class="d-block"><span class="d-block text-grey"style="color: crimson">Email:</span><span>info@goa.com</span></li>
              </ul>
            </div>
          </div>
          <div class="col-md-3 mb-5">
            ...
            <ul class="list-unstyled footer-link">
              <li><a href="#"style="color: crimson">About</a></li>
              <li><a href="#"style="color: crimson">Terms of Use</a></li>
              <li><a href="#"style="color: crimson">Disclaimers</a></li>
              <li><a href="#"style="color: crimson">Contact</a></li>
            </ul>
          </div>
          <div class="col-md-3">
