        ...
        <div class="container">
            ...
            <div class="row">
             ...
             <img  class="responsive" src="img/logo1.png"></a>
                <p class="d-flex">
                  <span class="ion-ios-location icon mr-5" style="color: crimson"></span>
                  <span>Saidabad, Hyderabad, Telangana,India</span>
                </p>

                <p class="d-flex">
                  <span class="ion-ios-telephone icon mr-5" style="color: crimson"></span>
                  <span>+91 XXXXXXXXXX</span>
                </p>

                <p class="d-flex">
                  <span class="ion-android-mail icon mr-5" style="color: crimson"></span>
