...
<!-- ======= Features Section ======= -->
        ...
        <ul class="nav nav-tabs row d-flex">
          ...
          <li class="nav-item col-3" data-aos="zoom-in" data-aos-delay="300">
            <a class="nav-link" data-toggle="tab" href="#tab-4">
              ...
              <h4 class="d-none d-lg-block">COVID GOA UPDATES</h4>
            </a>
          </li>
        </ul>
          ...
          <div class="tab-pane active show" id="tab-1">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                ...
                <p class="font-italic">
                  The following data provides data on testing done at centers in Karnataka for the treatment & diagnosis of COVID-19.
                </p>
                <ul>
 ...
 <iframe src="https://www.google.co.in/maps/d/embed?mid=1XP2qj3vxyMth9MiCNy9FUm9CzAbDPE7q" width="640" height="480"></iframe>
              </div>
            </div>
 ...
 <button id="mapsbtn">GO TO CHATBOT</button></a>
          ...
          <div class="tab-pane" id="tab-4">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                <h3>Clinics  & Testing centers in GOA</h3>
                ...
                <ul>
                  <li><i class="ri-check-double-line"></i> <n2 >GOA CONFIRMED<h2>
                  <n2 id="dc"><h2></li>
                  <li><i class="ri-check-double-line"></i>  <n2>GOA RECOVERED<h2>
                  <n2 id="dr"><h2></li>
                  <li><i class="ri-check-double-line"></i>  <n2>GOA DEATHS<h2>
                  <n2 id="dd"><h2></li>
                </ul>
              </div>
              <div class="col-lg-6 order-1 order-lg-2 text-center">
...
Array.prototype.sum = function (prop) {
    ...
    var DelhiConfirmed = covid_data[10].districtData.sum("confirmed");
    document.getElementById("dc").innerHTML = DelhiConfirmed
    var DelhiDeceased = covid_data[10].districtData.sum("deceased");
    document.getElementById("dd").innerHTML = DelhiDeceased
        var DelhiRecovered = covid_data[10].districtData.sum("deceased");
...
<div class="container table-responsive">
  ...
  <h1 style="text-align: center;">DAILY-RECORDS OF TESTING IN GOA</h1>
