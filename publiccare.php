...
<center>
 <a href="https://nhm.goa.gov.in/list-of-health-centres/" class="btn-buy"><button id="mapsbtn">LIST OF HEALTH-CARE CENTERS</button></a>
</center>
                        ...
                        <div class="container box_1170">
                            ...
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25" style="text-align: center;">Emergency Speciality Hospitals</h2>
                                    <?php
                                  $query = "SELECT * FROM healthcare WHERE state='goa'";
...
<div class="container table-responsive">
  <h1 style="text-align: center;">HEALTH-CARE CENTERS IN GOA</h1>
  <br><br>
  <!-- <CENTER>
